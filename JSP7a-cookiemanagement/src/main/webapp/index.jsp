...
<script>
    // Auto refresh page every 30 seconds to update cookie list
    setTimeout(function() {
...
<form action="setCookie.jsp" method="post">
    ...
    <table>
        <tr>
            ...
            <td><input type="text" name="cookieName" placeholder="Enter cookie name" required></td>
        </tr>
        <tr>
            <td><label>Domain:</label></td>
            <td><input type="text" name="domain" placeholder="e.g. localhost" required></td>
        </tr>
        <tr>
